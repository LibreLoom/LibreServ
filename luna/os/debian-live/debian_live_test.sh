...
assert_file_has "$OSROOT/debian-live/config/includes.chroot/etc/systemd/system/luna-installer.service" 'After=live-config.service' "installer must run after live-config"
