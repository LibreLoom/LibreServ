...
- Official setup code (purchased from LibreLoom)
...
- [ ] Factory stick: mount `LUNAASSETS`, put official setup codes in `TOKENS` (one per line); each flash peels the first line
