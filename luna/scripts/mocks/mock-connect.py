...
Usage:
  ...
  python3 luna/scripts/mocks/mock-connect.py
  # Or via wrapper / make:
  bash luna/scripts/mocks/mock-connect.sh
  make -C luna mock-connect

  # CLI control (communicates with running server or updates local state):
  python3 luna/scripts/mocks/mock-connect.py status
  python3 luna/scripts/mocks/mock-connect.py mode set <bound|unbound|challenge|401|backup_locked|storage_full>
  python3 luna/scripts/mocks/mock-connect.py domain set <subdomain> [custom_domain]
  python3 luna/scripts/mocks/mock-connect.py backup unlock
  python3 luna/scripts/mocks/mock-connect.py backup lock
  python3 luna/scripts/mocks/mock-connect.py backup stats
  python3 luna/scripts/mocks/mock-connect.py backup clean
  python3 luna/scripts/mocks/mock-connect.py mint-token [--write]
"""
...
def run_server(host: str, port: int, state_file: Path, storage_dir: Path, mode: str | None = None) -> int:
    ...
    print(f"  Status:          python3 luna/scripts/mocks/mock-connect.py status")
    print("=" * 60)
