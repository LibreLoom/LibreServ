import { Info, Laptop, Palette, Plug, Shield } from "lucide-react";
...
export function visibleCategories(isAdmin, connectActive = false) {
  return CATEGORIES.filter((c) => {
    if (!connectActive && c.id === "external_services") return false;
