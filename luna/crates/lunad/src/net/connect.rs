...
impl ConnectService {
    ...
    pub fn ensure_device_code_from_mag(&self) -> crate::system::factory_mag::MagFetchOutcome {
        crate::system::factory_mag::fetch_device_token_from_mag(
            &self.token_path,
            &crate::system::factory_mag::MagFetchOptions::default(),
        )
    }
