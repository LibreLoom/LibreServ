...
// known data breaches. It fails open on any HIBP API/network error (logs, no
// rejection) so password changes are never blocked by an outage. Returns ""
// when the password is allowed.
