...
func NewMonitoringHandlers(monitor *monitoring.Monitor, db *database.DB, runtimeClient *podman.Client, metricsCache *apps.AppMetricsCache) *MonitoringHandlers {
...
func (h *MonitoringHandlers) runComprehensiveHealthChecks(ctx context.Context) *ComprehensiveHealthResponse {
	...
	runCheck("disk_space", "system", func() (bool, string, interface{}) {
		...
		diskTotal = util.SafeDiskBytes(int64(stat.Blocks), stat.Bsize)
