        ...
        <Card className="bg-primary! text-secondary! border-2 border-secondary">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <CardButton
              ...
              className="bg-secondary! text-primary! hover:bg-primary! hover:text-secondary! hover:outline-secondary! mt-0"
            />
            <CardButton
              action="#"
            ...
            <CardButton
              ...
              className="bg-accent! text-primary! hover:bg-primary! hover:text-accent! hover:outline-accent! mt-0"
            />
          </div>
        </Card>
      </section>
