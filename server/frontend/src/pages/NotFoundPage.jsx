...
const quips = [
  "We looked everywhere. Even behind the couch. No page, though.",
  "This page took a wrong turn and is now enjoying the scenic route.",
  "That link went on an adventure. It hasn’t written back.",
  "You found a door that opens into… an empty room. Classic.",
  "Congratulations! You discovered our “nothing to see here” page.",
  "We checked the map. It says: “Not this way.”",
  "This page is temporarily unavailable due to being completely missing.",
  "We asked nicely. The page still didn’t show up.",
  "We searched high and low. Turns out it’s just… not here.",
  "If this page existed, it would be very impressed right now.",
];
