          ...
          <div className="markdown-content overflow-y-auto px-1">
            <ReactMarkdown
              components={{
                h1: (props) => (
                  <h1
                    className="text-3xl font-mono font-normal mb-4 mt-6 text-primary"
                    {...props}
                  />
                ),
                h2: (props) => (
                  <h2
                    className="text-2xl font-mono font-normal mb-3 mt-5 text-primary"
                    {...props}
                  />
                ),
                h3: (props) => (
                  <h3
                    className="text-xl font-mono font-normal mb-2 mt-4 text-primary"
                    {...props}
                  />
                ),
                h4: (props) => (
                  <h4
                    className="text-lg font-mono font-normal mb-2 mt-3 text-primary"
                    {...props}
                  />
                ),
                h5: (props) => (
                  <h5
                    className="text-base font-mono font-normal mb-2 mt-3 text-primary"
                    {...props}
                  />
                ),
                h6: (props) => (
                  <h6
                    className="text-sm font-mono font-normal mb-2 mt-2 text-primary"
                    {...props}
                  />
                ),
                p: (props) => <p className="mb-4 text-primary/90" {...props} />,
                ul: (props) => (
                  <ul
                ...
                li: (props) => <li className="mb-1 text-primary/90" {...props} />,
                code: ({ inline, ...props }) =>
                  inline ? (
                    <code
                      className="bg-primary/20 px-1 py-0.5 rounded text-sm text-primary"
                      {...props}
                    />
                  ) : (
                    <code
                      className="block bg-primary/10 text-primary p-4 rounded mb-4 overflow-x-auto"
                      {...props}
                    />
                  ),
                hr: (props) => (
                  <hr className="my-6 border-primary/30" {...props} />
                ),
                a: (props) => (
                  <a
