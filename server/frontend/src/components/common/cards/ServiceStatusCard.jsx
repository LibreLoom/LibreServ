...
function ServiceStatusCardInner({
  ...
  return (
    <div
      ref={outerRef}
      className="pop-in flex-1 mx-1.25 bg-secondary text-primary rounded-3xl p-5 motion-safe:transition transition-[height] ease-[var(--motion-easing-emphasized-decelerate)] self-start"
