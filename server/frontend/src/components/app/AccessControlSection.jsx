                ...
                {accessList.map((entry) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-4 py-2 rounded-pill border-2 border-error/40 text-error hover:bg-error/10 transition-colors font-mono text-sm shrink-0"
                    >
                      <Trash2 size={14} />
                      Revoke
                    </button>
