export default function MiniStatCard({ icon: Icon, label, value }) {
  return (
    <div className="pop-in motion-safe:transition-transform motion-safe:duration-300 motion-safe:ease-in-out hover:scale-[1.02] bg-primary text-secondary rounded-pill p-3 flex items-center gap-3">
