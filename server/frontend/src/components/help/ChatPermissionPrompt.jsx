...
const TOOL_LABELS = {
  docker_restart: "restart an app",
  docker_stop: "stop an app",
  docker_start: "start an app",
  file_write: "change a file",
  snapshot_restore: "restore from a backup",
  file_read: "read a file",
  config_read: "read a setting",
  docker_ps: "list apps",
  docker_logs: "view app logs",
  docker_inspect: "check app details",
  docker_health: "check if an app is healthy",
