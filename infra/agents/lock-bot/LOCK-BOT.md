...
No pull-request reviews. No webhook. Not the deleted infra/agents/nightly harness.
...
`/data/LibreServ/infra/agents/lock-bot/cook.sh`. Secrets stay in the env_file only.
...
- or `docker exec lock-bot /data/LibreServ/infra/agents/lock-bot/cook.sh`
