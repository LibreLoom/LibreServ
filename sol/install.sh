...
print_post_install() {
    ...
    echo -e "Logs: ${LOG_DIR}"
    echo ""
    echo -e "To upgrade: ${YELLOW}curl -fsSL https://gt.plainskill.net/LibreLoom/LibreServ/raw/branch/main/sol/install.sh -o install.sh && sudo bash install.sh --upgrade && rm install.sh${NC}"
    echo -e "To uninstall: ${YELLOW}curl -fsSL https://gt.plainskill.net/LibreLoom/LibreServ/raw/branch/main/sol/install.sh -o install.sh && sudo bash install.sh --uninstall && rm install.sh${NC}"
    echo ""
}
