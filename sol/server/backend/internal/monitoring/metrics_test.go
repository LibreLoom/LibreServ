...
func TestMetricsCollector_CollectAppMetrics_RuntimeUnavailable(t *testing.T) {
...
func TestMetricsCollector_CollectContainerMetrics_RuntimeUnavailable(t *testing.T) {
	mc := NewMetricsCollector(nil)
