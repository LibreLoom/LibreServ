...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        connectButton?.setOnClickListener {
            ...
            if (code.length != 6) {
                status.text = "Enter the 6-character code from your device"
    ...
    private fun startScan(code: String) {
        ...
        status.text = "Scanning for your LibreServ device…"
        btn.isEnabled = false
        ...
        android.os.Handler(android.os.Looper.getMainLooper()).postDelayed({
            ...
            if (panel != null && panel.visibility == View.VISIBLE && prog.visibility == View.VISIBLE) {
                status.text = "No LibreServ device found nearby. Make sure your device is powered on and within range."
                resetConnectUI()
            }
        }, 30_000)
    }
